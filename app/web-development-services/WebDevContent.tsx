        ...
        >
          <div className="text-center mb-16">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight leading-tight text-black">
              Web Development & Software Solutions Company
            </h1>
            <p className="text-xl text-fg-muted max-w-3xl mx-auto">
              Empowering startups and enterprises across industries with custom software development, modern web architectures, and premium AI integrations.
            </p>
          </div>
          ...
          <div className="space-y-16 text-lg text-fg-muted leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-semibold mb-6 text-black">Top-Tier Web Development for Global Brands</h2>
              <p className="mb-4">
                As a premier <strong>web development agency</strong>, Luminexis Technologies provides cutting-edge digital solutions tailored for high-growth enterprises and startups across multiple markets. We leverage our deep technical expertise to build responsive, light-speed, and highly secure web applications. Our dedicated team of expert web developers is committed to delivering digital products that not only look visually stunning but are engineered to scale flawlessly across all platforms and devices, handling intense traffic spikes without breaking a sweat.
              </p>
              <p>
                Whether you're looking for an expansive e-commerce platform, a corporate informational portal, or complex highly-interactive dashboards, our architectural approach guarantees a product that acts as a powerhouse for your business logic. We seamlessly blend intuitive UI/UX design with robust backend technologies to maximize your conversion rates and operational efficiency for modern digital businesses.
              </p>
              <p className="mt-4">
                 Our web development approach is uniquely equipped to manage complex enterprise requirements across diverse industries. By implementing industry-standard practices and robust deployment pipelines, we guarantee a foundation that sets you years ahead of your competitors.
              </p>
            </section>

            <section>
              <h2 className="text-3xl font-semibold mb-6 text-black">Mastering Custom Software Development</h2>
              <p className="mb-4">
                Off-the-shelf software rarely fits the ambitious, highly-specific processes of a scaling corporation. This is why our <strong>custom software development</strong> services focus strictly on building bespoke tools, CRM integrations, and SaaS platforms from the ground up for businesses across industries. Over the years, we've realized that the strongest differentiator in business operations is proprietary software that adapts entirely to the nuances of your industry instead of forcing your team to adapt to rigid external formulas.
              </p>
              <p className="mb-4">
                We believe that every technical architecture should reflect the nuanced demands of the business model. By combining modern frameworks such as Next.js, React, Node.js, and sophisticated cloud infrastructure, we build applications that accelerate workflows rather than hinder them. From high availability database modeling to sub-second API resolution, our teams master every layer of modern software development for modern digital businesses.
              </p>
              <p>
            ...
            <section>
              <h2 className="text-3xl font-semibold mb-6 text-black">AI Chatbot Development & Future-Proof Technologies</h2>
              <p className="mb-4">
                Step into the era of modern customer interaction with our specialized <strong>AI chatbot development company</strong> services. Rather than relying on generic auto-responders, we create intelligent, context-aware digital assistants capable of understanding nuance, guiding user journeys, and accurately resolving customer inquires 24/7.
              </p>
              <p className="mb-4">
                By linking advanced language models with your own internal knowledge bases, our AI chatbot integrations serve as highly effective lead-generation and customer-support tools. This drastically reduces manual support overhead while maintaining incredibly high customer satisfaction rates. They aren't just FAQ bots—they act as virtual sales representatives uniquely trained on your business data for startups and enterprises.
              </p>
              <p>
                Investing in AI now means securing a competitive moat. We implement retrieval-augmented generation (RAG) methodologies ensuring our chatbots don't hallucinate but strictly rely on your corporate literature to deliver flawless solutions across multiple markets.
              </p>
            </section>
            ...
            <section className="my-16">
              ...
              <div className="space-y-6">
                <div className="border-b border-black/10 pb-4">
                  ...
                  <p>Typical business portals take 4–8 weeks, whereas complex SaaS applications and custom software development projects can range from 3 to 6 months depending on requirements for startups and enterprises.</p>
                </div>
                <div className="border-b border-black/10 pb-4">
                  <h3 className="text-xl font-bold text-black mb-2">Do you provide ongoing maintenance?</h3>
                  <p>Absolutely. We offer competitive retainer packages to ensure your systems remain up-to-date, secure, and optimized as your business scales for modern digital businesses.</p>
                </div>
                <div className="border-b border-black/10 pb-4">
                  <h3 className="text-xl font-bold text-black mb-2">Are your AI chatbot services easily integrated?</h3>
                  <p>Yes. Our AI chatbot solutions can securely hook into any modern webpage or software ecosystem via scalable APIs, requiring virtually no downtime during implementation for businesses across industries.</p>
                </div>
              </div>
            </section>
